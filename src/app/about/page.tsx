export default function About() {
  ...
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-200px)] p-4 sm:p-8">
      <div className="bg-gradient-to-br from-white/95 to-white/90 rounded-[20px] p-8 sm:p-12 max-w-[700px] w-full shadow-[0_20px_60px_rgba(0,0,0,0.15)] backdrop-blur-[10px] border border-white/30">
        {/* Header */}
        <div className="text-center mb-10">
          <h1 className="text-2xl sm:text-[2rem] md:text-[2.5rem] font-bold mb-4 bg-gradient-to-r from-purple-600 to-indigo-500 bg-clip-text text-transparent">
            About me
          </h1>
        ...
        <div className="flex flex-col gap-8">
          ...
          <p className="text-lg sm:text-xl leading-[1.8] text-gray-700">
  Hello! I&apos;m <strong className="text-purple-600 font-semibold">JosePVG-Dev</strong>, a developer passionate about creating interactive experiences and creative projects.
            ...
            <p className="text-base sm:text-lg leading-[1.8] text-gray-600">
